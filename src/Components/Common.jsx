                    ...
                    <div className="col-10 mx-auto">
                        <div className="row">
                            <div className="col-md-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex justify-content-center flex-column">
                                ...
                                <h2 className="my-3">
                                    An online, AI-based resume builder that gets you more interviews · Start building ; Your resume optimized for Applicant Tracking Systems (ATS) · Beat the system.
                                </h2>
                                <div className="mt-3">
